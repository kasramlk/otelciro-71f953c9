  ...
  public: {
    Tables: {
      ...
      beds24_api_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_api_logs_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "beds24_connections"
            referencedColumns: ["id"]
          },
        ]
      }
      beds24_bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_bookings_beds24_property_id_fkey"
            columns: ["beds24_property_id"]
            isOneToOne: false
            referencedRelation: "beds24_properties"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "beds24_bookings_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "beds24_connections"
            referencedColumns: ["id"]
      ...
      beds24_inventory: {
        Row: {
          ...
          synced_from_beds24: boolean | null
        }
        Insert: {
          available?: number | null
          beds24_property_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_inventory_beds24_property_id_fkey"
            columns: ["beds24_property_id"]
            isOneToOne: false
            referencedRelation: "beds24_properties"
            referencedColumns: ["id"]
      ...
      beds24_properties: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_properties_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "beds24_connections"
            referencedColumns: ["id"]
      ...
      beds24_rooms: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_rooms_beds24_property_id_fkey"
            columns: ["beds24_property_id"]
            isOneToOne: false
            referencedRelation: "beds24_properties"
            referencedColumns: ["id"]
      ...
      beds24_sync_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_sync_logs_beds24_property_id_fkey"
            columns: ["beds24_property_id"]
            isOneToOne: false
            referencedRelation: "beds24_properties"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "beds24_sync_logs_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "beds24_connections"
            referencedColumns: ["id"]
      ...
      beds24_webhooks: {
        ...
        Relationships: [
          {
            foreignKeyName: "beds24_webhooks_connection_id_fkey"
            columns: ["connection_id"]
            isOneToOne: false
            referencedRelation: "beds24_connections"
            referencedColumns: ["id"]
