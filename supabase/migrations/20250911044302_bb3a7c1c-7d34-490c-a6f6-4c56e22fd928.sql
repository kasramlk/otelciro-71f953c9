...
-- Create default rate plans (delete first to avoid conflicts)
DELETE FROM rate_plans WHERE hotel_id = '6163aacb-81d7-4eb2-ab68-4d3e172bef3e';
DELETE FROM inventory WHERE hotel_id = '6163aacb-81d7-4eb2-ab68-4d3e172bef3e';
DELETE FROM daily_rates WHERE hotel_id = '6163aacb-81d7-4eb2-ab68-4d3e172bef3e';
