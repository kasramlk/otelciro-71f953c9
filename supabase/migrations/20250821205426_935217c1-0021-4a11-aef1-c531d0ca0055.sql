-- Create guest_profiles table for enhanced guest management
...
-- Create RLS policies
CREATE POLICY "guest_profiles_rw" ON public.guest_profiles
...
CREATE INDEX idx_guest_profiles_guest_hotel ON public.guest_profiles(guest_id, hotel_id);
