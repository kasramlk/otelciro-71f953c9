-- Fix security issues: Enable RLS and fix function search paths (without dropping dependencies)
...
-- Update function search paths without dropping (use OR REPLACE)
...
-- Fix the calculate_next_run function (it wasn't created with proper search path)
