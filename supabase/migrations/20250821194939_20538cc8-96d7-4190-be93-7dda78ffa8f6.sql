...
-- Insert sample data for demo purposes (with correct event types)
...
('Istanbul Fashion Week', 'Major fashion event attracting international visitors', 'trade_show', 'Istanbul, Turkey', '2024-03-15', '2024-03-22', 'high', 1.8),
