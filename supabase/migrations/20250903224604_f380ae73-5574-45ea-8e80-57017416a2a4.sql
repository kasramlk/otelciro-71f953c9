-- 🧱 FIX VIEWS: Update column names to match specification

-- Fix v_external_ids view to expose 'entity' instead of 'entity_type'
...
-- Fix v_ingestion_audit view with normalized credit headers
